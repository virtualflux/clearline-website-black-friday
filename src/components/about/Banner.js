...
const AboutBanner = () => {
  return (
    <div className="px-16 max-lg:px-12 max-md:px-8 pt-32 max-md:pt-24">
      <div className="flex max-sm:flex-col justify-between items-center gap-8 max-md:gap-4 mb-12 max-md:mb-6">
      ...
      <div className="relative w-full h-[500px] max-md:h-[230px] flex flex-col items-center">
        ...
        />
        <div className="absolute top-[200px] max-md:top-[110px] w-4/5 px-12 max-md:px-6 max-md:py-3 py-6 bg-catalineBlue text-white">
